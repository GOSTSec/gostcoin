...
void ClientModel::subscribeToCoreSignals()
{
    ...
    uiInterface.NotifyNumI2PConnectionsChanged.connect(boost::bind(NotifyNumI2PConnectionsChanged, this, boost::placeholders::_1));
}
...
void ClientModel::unsubscribeFromCoreSignals()
{
    ...
    uiInterface.NotifyNumI2PConnectionsChanged.disconnect(boost::bind(NotifyNumI2PConnectionsChanged, this, boost::placeholders::_1));
}
