...
#else
        ip::tcp::resolver resolver(stream.get_io_context());
#endif
...
#else
    AcceptedConnectionImpl<Protocol>* conn = new AcceptedConnectionImpl<Protocol>(acceptor->get_io_context(), context, fUseSSL);
#endif
